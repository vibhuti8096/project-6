  ...
  str += `
    <div class="col-3">
      <div class="card mt-5 p-3" style="width: 20rem;">
        ...
        <h5 class="card-title">${prct.title || 'Card title'}</h5>
        <h6 class="card-subtitle text-body-secondary">${prct.subtitle || ''}</h6>
        <span class="item-price">${prct.price}Rs.</span>
        <span><i class="fa-regular fa-star"></i></span>
        <div class="d-flex">
          <button  class="m-2 p-2 rounded" onclick='addToCart(${JSON.stringify(prct)})'><a href="" class="card-link text-decoration-none text-primary">Add Card</a></button>
...
function renderBadge() {
  ...
  let str1 = "";
str1 += `
  <a href="cart.html"> <button type="button" class="btn btn-primary position-relative mt-3">
